...
const CreateMemories = () => {
    ...
    return (
      ...
      {/* AI message */}
      <Flex mb={9} justifyContent="flex-start">
        <Avatar name='AI' src='https://bit.ly/prosper-baba' />
        <Box ml={3} maxW={['70%', '320px']} p={4} borderWidth="1px" bg="gray.500" rounded="xl">
          <Flex justify="space-between" alignItems="center" mb={2}>
            <span className="text-sm font-semibold text-gray-900">Memora-AI</span>
          </Flex>
          <p className="text-sm font-normal py-2.5 text-gray-900">That is awesome. I think our users will really appreciate the improvements.</p>
        </Box>
      </Flex>

      {/* User message */}
      <Flex mb={9} justifyContent="flex-end">
        <Box mr={3} maxW={['70%', '320px']} p={4} borderWidth="1px" bg="gray.300" rounded="xl">
          <Flex justify="space-between" alignItems="center" mb={2}>
            <span className="text-sm font-semibold text-gray-900">Gabriel</span>
          </Flex>
          <p className="text-sm font-normal py-2.5 text-gray-900">Thank you! Im glad you like it.</p>
        </Box>
